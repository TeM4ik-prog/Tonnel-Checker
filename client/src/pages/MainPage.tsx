...
export const MainPage: React.FC = () => {
    ...
    return (
        <>
            ...
            <Section>
                <section className="relative max-h-full w-full gap-4 h-screen  bg-cover bg-center flex flex-col items-center justify-center text-center rounded"
                    style={{
                ...
                >
                    ...
                    <Button color="red" text="Узнать больше" />
